...
--
-- Host: localhost:8001
-- Generation Time: Feb 15, 2017 at 06:22 PM
...
ALTER TABLE `festival_comment`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_festivals` (`id_festival`),
...
ALTER TABLE `festival_performer`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_festivals` (`id_festival`),
  ADD KEY `id_performers` (`id_performer`);
...
ALTER TABLE `festival_rating`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id_festival_2` (`id_festival`,`id_user`),
  ADD KEY `id_festival` (`id_festival`),
...
--
ALTER TABLE `festival_comment`
  ADD CONSTRAINT `festival_comment_ibfk_1` FOREIGN KEY (`id_festival`) REFERENCES `festival` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `festival_comment_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `festival_performer`
--
ALTER TABLE `festival_performer`
  ADD CONSTRAINT `festival_performer_ibfk_1` FOREIGN KEY (`id_performer`) REFERENCES `performer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `festival_performer_ibfk_2` FOREIGN KEY (`id_festival`) REFERENCES `festival` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `festival_rating`
--
ALTER TABLE `festival_rating`
  ADD CONSTRAINT `festival_rating_ibfk_1` FOREIGN KEY (`id_festival`) REFERENCES `festival` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `festival_rating_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `reservation`
  ...
  ADD CONSTRAINT `reservation_ibfk_2` FOREIGN KEY (`id_ticket`) REFERENCES `ticket` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `social_network`
--
ALTER TABLE `social_network`
  ADD CONSTRAINT `social_network_ibfk_1` FOREIGN KEY (`id_festival`) REFERENCES `festival` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `ticket`
--
ALTER TABLE `ticket`
  ADD CONSTRAINT `ticket_ibfk_1` FOREIGN KEY (`id_festival`) REFERENCES `festival` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
